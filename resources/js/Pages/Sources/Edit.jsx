...
export default function Edit({ auth, errors, source, channels }) {
    return (
        <AuthenticatedLayout
            auth={auth}
            errors={errors}
                        ...
                        <div className="p-6 bg-white border-b border-gray-200 flex">
                            <div className='w-1/4'>
                                <h1 className='text-2xl font-black mb-3'>
                                    Sources 
                                    <Link className='text-sm bg-gray-100 hover:bg-gray-200 px-2 font-semibold hover:font-bold rounded ml-2' href={route('sources.index')}>Back ⏎</Link>
                                </h1>
